...
export default function CertifiedSection() {
  ...
  const content = [
    {
      title: "Young Innovator Certified",
      desc: "Completed hands-on robotics activities and built their first working prototype."
    },
    {
      title: "AI Explorer Certified",
      desc: "Learned fundamentals of machine intelligence and created simple AI models."
    },
    {
      title: "Creative Robotics Builder",
      desc: "Designed mini-machines using motors, sensors, and logical thinking."
    },
    {
      title: "School Tech Achiever",
      desc: "Recognized for exceptional performance in STEM workshops hosted by HenceProve."
    },
    {
      title: "Future Tech Leader",
      desc: "Showed strong problem-solving skills and teamwork in STEM challenges."
    },
    {
      title: "Junior AI Researcher",
      desc: "Experimented with image detection, automation, and smart logic activities."
    },
    {
