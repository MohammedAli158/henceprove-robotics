...
export default function AltComponent(){
    return (
        <section className="min-h-screen flex flex-col m-5 mt-0 bg-orange-500 rounded-xl shadow-[0_4px_10px_rgba(0,0,0,0.25)] " >
            <div className="flex m-5 max-h-[45vh] p-5 text-white rounded-xl border-b border-[#d9d9da] " >
